...
const functionNames = [
  'pollPads', 'updateWonders', 'rollWonders', 'wonderBlast', 'wonderTap', 'wonderTapHost', 'wonderLog', 'drawWonders', 'drawWonderAir', 'wonderStarPos', 'WONDERS', 'markWonder', 'unlockAudio', 'setEffectsVolume', 'chime', 'blastTone', 'listenRun', 'RUN_CUES',
