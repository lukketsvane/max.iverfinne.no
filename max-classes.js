(function (root) {
  ...
  var all = [
    ...
    { id: 'polge', name: 'Pølge', special: 'stand-in', desc: 'An abandoned mannequin who learned to fall on purpose. Quick rolls, clumsy tending. Tap to leave a stand-in: pests bite it instead, then it bursts into splinters. Bosses know better.', speed: 1.05, jump: 1, control: 1.1, dodgeRecovery: .65, stagger: 1.2, care: .75, knockback: .8, protection: 0, radius: 0, robot: 0, seeds: .55, skill: 'standin', skillCd: 11, standinTime: 6, standinRadius: 70, standinHits: 3 },
    // Hidden until unlocked (easter-eggs.mjs). The tun's cooldown counts from the moment it uncurls.
    { id: 'sligo', name: 'Sligo', fullName: 'Max Sligo Neverdahl', hidden: true, special: 'tun', desc: 'The forgotten, defiled zygote. The gluttonous twins JP and IE sucked out Sligo’s endoplasm and tried to starve him out of the Triforce. He survived. His cords harvest meat: eat to grow, throw flesh to shrink. At 1.75 times Max’s height he divides, up to four divisions per run. Hold a clone to swap control; the others follow and defend. Tap Sligo to curl into a tun; nearby plants take half damage.', speed: 1, jump: 1, control: 1, dodgeRecovery: 1, stagger: 1, care: 1, knockback: 1, protection: 0, radius: 0, robot: 0, seeds: .55, skill: 'tun', skillCd: 9, tunTime: 3, tunRadius: 40, tunProtection: .5 }
  ];
