(function (root) {
  ...
  var all = [
    { id: 'mech', name: 'Mech', special: 'robots', desc: 'Owns the watering rover. Tap Max to dispatch it to the plant under attack: it floods the soil, scares biters and mends the plant.', speed: 1, jump: 1, control: 1, dodgeRecovery: 1, stagger: 1, care: 1, knockback: 1, protection: 0, radius: 0, robot: 1, skill: 'dispatch', skillCd: 8 },
    ...
    { id: 'bulwark', name: 'Bulwark', special: 'guard', desc: 'Guards nearby plants. Tap Max to brace: a wider, stronger guard that swallows warned roots. Moving ends it.', speed: .85, jump: 1, control: 1, dodgeRecovery: 1, stagger: 1.5, care: 1, knockback: .55, protection: .3, radius: 48, robot: 0, skill: 'brace', skillCd: 10, braceTime: 3, braceProtection: .65, braceRadius: 64 },
