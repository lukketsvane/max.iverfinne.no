(function (root) {
  ...
  var all = [
    ...
    { id: 'polge', name: 'Pølge', special: 'stand-in', desc: 'The glue of the friend group. Pølgevenner stick together. Quick rolls, clumsy tending. Tap to leave a stand-in: pests bite it, then it bursts into splinters. Bosses know better.', speed: 1.05, jump: 1, control: 1.1, dodgeRecovery: .65, stagger: 1.2, care: .75, knockback: .8, protection: 0, radius: 0, robot: 0, seeds: .55, skill: 'standin', skillCd: 11, standinTime: 6, standinRadius: 70, standinHits: 3 },
