(function (root) {
  ...
  var all = [
    ...
    { id: 'sligo', name: 'Sligo', fullName: 'Max Sligo Neverdahl', hidden: true, special: 'tun', desc: 'The forgotten, defiled zygote. The gluttonous twins JP and IE sucked out Sligo’s endoplasm and tried to starve him out of the Triforce. He survived. He grows two umbilical cords and throws pieces of himself that burst into blood clots. Tap Sligo to curl into a tun; nearby plants take half damage.', speed: 1, jump: 1, control: 1, dodgeRecovery: 1, stagger: 1, care: 1, knockback: 1, protection: 0, radius: 0, robot: 0, seeds: .55, skill: 'tun', skillCd: 9, tunTime: 3, tunRadius: 40, tunProtection: .5 }
  ];
