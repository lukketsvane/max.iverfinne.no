(function (root) {
  ...
  var all = [
    ...
    { id: 'bulwark', name: 'Bulwark', special: 'guard', desc: 'Guards nearby plants. Tap Max to brace: a wider, stronger guard that swallows warned roots. Moving ends it.', speed: .85, jump: 1, control: 1, dodgeRecovery: 1, stagger: 1.5, care: .45, knockback: .55, protection: .3, radius: 48, robot: 0, skill: 'brace', skillCd: 10, braceTime: 3, braceProtection: .65, braceRadius: 64 },
