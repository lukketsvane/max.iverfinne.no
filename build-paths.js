(function(root){
  ...
  var perks=[
    ...
    {id:'robot',name:'Companion',desc:'Larger tank and reach',path:1,max:2},
    ...
    {id:'recycle',name:'Rain engine',desc:'Harvest refills your robot',path:1,max:1,needs:{robot:2,yield:1}},
