...
for (const file of ['atlas.json', 'main.png', 'interaction.png', 'specials.png', 'specials.json', 'mutations.png', 'mutations.json']) copyFileSync(join(root, 'assets/max-skins-v1/sligo', file), join(output, 'assets/max-skins-v1/sligo', file));
