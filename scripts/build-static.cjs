...
const files = ['index.html', 'run-results.js', 'run-results.css', 'game-menu.css', 'companion.js', 'build-paths.js', 'max-classes.js', 'stage-layout.js', 'garden-places.js', 'levels-data.js', 'levels.js', 'review.html'];
